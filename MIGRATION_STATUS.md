...
|-------------|-------|------------|
| 9-10 (✅)   | 17    | ActionsDropdown (9.5), AdvancedFilters (9), Avatar (9.5), BooleanIcon (9), Breadcrumb (9), BulkActions (9), Calendar (9), Card (9), Carousel (9), Chart (9), Clipboard (9), Columns (9), DataTable (9), DeleteLink (9), Drawer (9), Dropdown (9), Modal (9) |
| 7-8 (⚠️)    | 0     | - |
| < 7 (❌)    | 0     | - |
| Not scored  | 39    | Remaining components |
