...
require 'bali/builder_html_utils'
require 'bali/shared_form_builder_utils'
require 'bali/field_group_wrapper'
...
builder_helpers = File.expand_path(
  File.join(File.dirname(__FILE__), 'bali/form_builder_helpers', '*_fields.rb')
)
