    ...
    class SelectOptions
      class << self
        def yearly_quarter
          ...
          [
            [ I18n.t("bali_view.time_periods.yearly"), Time.zone.now.all_year ],
        ...
        def trailing
          [
            [ I18n.t("bali_view.time_periods.yesterday"), Time.zone.now.yesterday.all_day ],
            [ I18n.t("bali_view.time_periods.last_7_days"),
             7.days.ago.beginning_of_day..Time.zone.now.yesterday.end_of_day ],
            [ I18n.t("bali_view.time_periods.last_30_days"),
             30.days.ago.beginning_of_day..Time.zone.now.yesterday.end_of_day ],
            [ I18n.t("bali_view.time_periods.last_12_weeks"),
             11.weeks.ago.beginning_of_week..Time.zone.now.end_of_week ],
            [ I18n.t("bali_view.time_periods.last_12_months"),
