...
class BaliCarouselComponentTest < ComponentTestCase
  def setup
    @options = {}
  end
...
class BaliCarouselArrowsComponentTest < ComponentTestCase
...
class BaliCarouselBulletsComponentTest < ComponentTestCase
  def test_uses_translations_for_accessibility_labels
    I18n.with_locale(:es) do
