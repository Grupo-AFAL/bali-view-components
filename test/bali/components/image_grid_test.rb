...
class Bali_ImageGrid_ComponentTest < ComponentTestCase
  #
...
class Bali_ImageGrid_Image_ComponentTest < ComponentTestCase
  #
...
class Bali_ImageGrid_Image_FooterComponentTest < ComponentTestCase
