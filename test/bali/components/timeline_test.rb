...
class Bali_Timeline_ComponentTest < ComponentTestCase
  #
...
class Bali_Timeline_Item_ComponentTest < ComponentTestCase
  #
...
class Bali_Timeline_Header_ComponentTest < ComponentTestCase
  #
