...
class Bali_Avatar_ComponentTest < ComponentTestCase
  def setup
    @options = {}
  end
...
class Bali_Avatar_Upload_ComponentTest < ComponentTestCase
  def setup
...
class Bali_Avatar_Group_ComponentTest < ComponentTestCase
...
class Bali_Avatar_Picture_ComponentTest < ComponentTestCase
