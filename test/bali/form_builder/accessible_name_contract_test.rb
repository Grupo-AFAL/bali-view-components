...
# The accessibility contract every `*_group` owes its caller:
#
...
class BaliFormBuilderAccessibleNameContractTest < FormBuilderTestCase
  ...
  GROUPS = {
    "text_group" => [ ->(b) { b.text_group(:name) }, "movie_name" ],
    "email_group" => [ ->(b) { b.email_group(:name) }, "movie_name" ],
    "url_group" => [ ->(b) { b.url_group(:name) }, "movie_name" ],
    "password_group" => [ ->(b) { b.password_group(:name) }, "movie_name" ],
    "number_group" => [ ->(b) { b.number_group(:budget) }, "movie_budget" ],
    "month_group" => [ ->(b) { b.month_group(:release_date) }, "movie_release_date" ],
    "text_area_group" => [ ->(b) { b.text_area_group(:synopsis) }, "movie_synopsis" ],
    "date_group" => [ ->(b) { b.date_group(:release_date) }, "movie_release_date" ],
    "datetime_group" => [ ->(b) { b.datetime_group(:release_date) },
                               "movie_release_date" ],
    ...
    "range_group" => [ ->(b) { b.range_group(:rating) }, "movie_rating" ],
    "boolean_group" => [ ->(b) { b.boolean_group(:indie) }, :wrapping_label ],
    "switch_group" => [ ->(b) { b.switch_group(:indie) }, :wrapping_label ],
    "radio_group" => [ ->(b) { b.radio_group(:status, [ %w[One 1] ]) }, :legend ],
    "radio_buttons_group" => [ ->(b) { b.radio_buttons_group(:status, { a: [ %w[One 1] ] }) },
                              :legend ],
    "coordinates_polygon_group" => [ ->(b) { b.coordinates_polygon_group(:name) },
                                          :legend ],
    "block_editor_group" => [ ->(b) { b.block_editor_group(:synopsis) }, :legend ],
    "rich_text_area_group" => [ ->(b) { b.rich_text_area_group(:synopsis) }, :legend ],
    "recurrent_event_rule_group" => [ ->(b) { b.recurrent_event_rule_group(:rule) },
                                           :legend ]
  }.freeze
  ...
  DESCRIBED = {
    ...
    "select_group" => ->(b, o) { b.select_group(:name, [], html: o) },
    "slim_select_group" => ->(b, o) { b.slim_select_group(:name, [], html: o) },
    ...
    "radio_group" => ->(b, o) { b.radio_group(:name, [ %w[One 1] ], **o) },
  ...
  def test_a_checkbox_with_no_inline_caption_and_no_legend_is_reported_as_unnamed
    document = fragment(builder.boolean_group(:indie, text: false))

    refute_nil resolve_wrapping_label("boolean_group", document),
