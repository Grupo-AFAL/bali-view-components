...
class BaliConcernsDateRangeAttributeActiveModelTest < ActiveSupport::TestCase
  def setup
...
class BaliConcernsDateRangeAttributeWorkingPeriodTest < ActiveSupport::TestCase
  def setup
    @model = Workout.new
  end
