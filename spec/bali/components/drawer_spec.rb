...
RSpec.describe Bali::Drawer::Component, type: :component do
  ...
  it 'renders when active is true' do
    ...
    expect(page).to have_css 'div.drawer.is-active'
  end

  it 'renders when active is false' do
    render_inline(component)

    expect(page).to have_css 'div.drawer'
  end
  ...
  it 'renders with custom class' do
    ...
    expect(page).to have_css 'div.drawer-component.custom-class', text: 'Hello World!'
  end
end
