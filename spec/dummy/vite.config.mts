...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^@blocknote\/xl-ai$/, replacement: resolve(__dirname, 'node_modules/@blocknote/xl-ai') },
      { find: '@blocknote/xl-ai/style.css', replacement: resolve(__dirname, 'node_modules/@blocknote/xl-ai/src/style.css') },
      { find: '@blocknote/xl-ai/locales', replacement: resolve(__dirname, 'node_modules/@blocknote/xl-ai/dist/locales.js') },
      { find: /^ai$/, replacement: resolve(__dirname, 'node_modules/ai') },
