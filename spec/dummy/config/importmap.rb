...
pin "@tiptap/core", to: 'https://cdn.jsdelivr.net/npm/@tiptap/core@2.8.0/dist/index.min.js'
pin "@tiptap/pm", to: 'https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/state/dist/index.min.js'
pin "@tiptap/pm/commands", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/commands/dist/index.js"
pin "@tiptap/pm/dropcursor", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/dropcursor/dist/index.js"
pin "@tiptap/pm/gapcursor", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/gapcursor/dist/index.js"
pin "@tiptap/pm/history", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/history/dist/index.js"
pin "@tiptap/pm/keymap", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/keymap/dist/index.js"
pin "@tiptap/pm/model", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/model/dist/index.js"
pin "@tiptap/pm/schema-list", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/schema-list/dist/index.js"
pin "@tiptap/pm/state", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/state/dist/index.js"
pin "@tiptap/pm/tables", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/tables/dist/index.js"
pin "@tiptap/pm/transform", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/transform/dist/index.js"
pin "@tiptap/pm/view", to: "https://cdn.jsdelivr.net/npm/@tiptap/pm@2.8.0/view/dist/index.js"
pin "@tiptap/suggestion", to: 'https://cdn.jsdelivr.net/npm/@tiptap/suggestion@2.8.0/dist/index.min.js'
pin "@tiptap/prosemirror-tables", to: 'https://cdn.jsdelivr.net/npm/@tiptap/prosemirror-tables@1.1.4/dist/index.cjs.min.js'
pin "@tiptap/starter-kit", to: 'https://cdn.jsdelivr.net/npm/@tiptap/starter-kit@2.8.0/dist/index.min.js'

pin "@tiptap/extension-blockquote", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-blockquote@2.8.0/dist/index.min.js'
pin "@tiptap/extension-bold", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-bold@2.8.0/dist/index.min.js'
pin "@tiptap/extension-bubble-menu", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-bubble-menu@2.8.0/+esm'
pin "@tiptap/extension-bullet-list", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-bullet-list@2.8.0/dist/index.min.js'
pin "@tiptap/extension-code-block-lowlight", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-code-block-lowlight@2.8.0/dist/index.js'
pin "@tiptap/extension-code-block", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-code-block@2.8.0/dist/index.min.js'
pin "@tiptap/extension-code", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-code@2.8.0/dist/index.min.js'
pin "@tiptap/extension-color", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-color@2.8.0/dist/index.min.js'
pin "@tiptap/extension-document", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-document@2.8.0/dist/index.min.js'
pin "@tiptap/extension-dropcursor", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-dropcursor@2.8.0/dist/index.min.js'
pin "@tiptap/extension-gapcursor", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-gapcursor@2.8.0/dist/index.min.js'
pin "@tiptap/extension-hard-break", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-hard-break@2.8.0/dist/index.min.js'
pin "@tiptap/extension-heading", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-heading@2.8.0/dist/index.min.js'
pin "@tiptap/extension-history", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-history@2.8.0/dist/index.min.js'
pin "@tiptap/extension-horizontal-rule", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-horizontal-rule@2.8.0/dist/index.min.js'
pin "@tiptap/extension-image", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-image@2.8.0/dist/index.min.js'
pin "@tiptap/extension-italic", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-italic@2.8.0/dist/index.min.js'
pin "@tiptap/extension-link", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-link@2.8.0/dist/index.min.js'
pin "@tiptap/extension-list-item", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-list-item@2.8.0/dist/index.min.js'
pin "@tiptap/extension-mention", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-mention@2.8.0/dist/index.min.js'
pin "@tiptap/extension-ordered-list", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-ordered-list@2.8.0/dist/index.min.js'
pin "@tiptap/extension-paragraph", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-paragraph@2.8.0/dist/index.min.js'
pin "@tiptap/extension-placeholder", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-placeholder@2.8.0/dist/index.min.js'
pin "@tiptap/extension-strike", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-strike@2.8.0/dist/index.min.js'
pin "@tiptap/extension-table-cell", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-table-cell@2.8.0/dist/index.min.js'
pin "@tiptap/extension-table-header", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-table-header@2.8.0/dist/index.min.js'
pin "@tiptap/extension-table-row", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-table-row@2.8.0/dist/index.min.js'
pin "@tiptap/extension-table", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-table@2.8.0/dist/index.min.js'
pin "@tiptap/extension-text-align", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-text-align@2.8.0/dist/index.min.js'
pin "@tiptap/extension-text-style", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-text-style@2.8.0/dist/index.min.js'
pin "@tiptap/extension-text", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-text@2.8.0/dist/index.min.js'
pin "@tiptap/extension-underline", to: 'https://cdn.jsdelivr.net/npm/@tiptap/extension-underline@2.8.0/+esm'
...
pin "prosemirror-commands", to: 'https://cdn.jsdelivr.net/npm/prosemirror-commands@1.6.1/dist/index.min.js'
...
pin "prosemirror-model", to: 'https://cdn.jsdelivr.net/npm/prosemirror-model@1.23.0/dist/index.min.js'
...
pin "prosemirror-tables", to: 'https://cdn.jsdelivr.net/npm/prosemirror-tables@1.5.0/dist/index.min.js'
...
pin "prosemirror-view", to: 'https://cdn.jsdelivr.net/npm/prosemirror-view@1.34.3/dist/index.min.js'
