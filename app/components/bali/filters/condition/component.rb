    ...
    module Condition
      class Component < ApplicationViewComponent
        ...
        def placeholders_translations
          {
            ...
            number: t("bali_view.filters.placeholders.number"),
        ...
        def boolean_translations
          {
            any: t("bali_view.filters.boolean.any"),
            yes: t("bali_view.filters.boolean.yes"),
            no: t("bali_view.filters.boolean.no")
          }
        end

        # rubocop:disable Style/FormatStringToken -- %{count} is Rails I18n format
        def selected_count_translation
          t("bali_view.filters.selected_count")
        end
