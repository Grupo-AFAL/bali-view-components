...
module Bali
  module Filters
    class Component < ApplicationViewComponent
      ...
      def button_text
        @button_text || I18n.t("bali_view.filters.filters_button", default: "Filters")
      end
      ...
      def translations_json
        {
          combinators: {
            and: I18n.t("bali_view.filters.combinators.and", default: "AND"),
            or: I18n.t("bali_view.filters.combinators.or", default: "OR")
          }
        }.to_json
      end
