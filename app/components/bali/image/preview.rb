module Bali
  module Image
    class Preview < ApplicationViewComponentPreview
      ...
      def default
        render(Bali::Image::Component.new)
      end
      ...
      def with_image(image_url: 'avatar.png')
        render(Bali::Image::Component.new(image_url))
      end
      ...
      def with_input
        render_with_template(template: 'bali/image/previews/with_input')
      end
      ...
      def with_custom_clear_button
        render_with_template(template: 'bali/image/previews/with_custom_clear_button')
      end
    end
  end
end
