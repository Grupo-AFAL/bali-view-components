...
module Bali
  module Modal
    class Component < ApplicationViewComponent
      ...
      def close_label
        I18n.t("bali_view.modal.close", default: "Close modal")
      end
      ...
      def confirm_close_message
        @confirm_close_message.presence || I18n.t("bali_view.modal.confirm_close", default: "You have unsaved changes. Discard them?")
      end
    end
  end
end
