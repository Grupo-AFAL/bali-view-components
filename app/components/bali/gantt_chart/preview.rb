    ...
    class Preview < ApplicationViewComponentPreview
      ...
      def tasks
        ...
        return [
          ...
          { id: 4, name: 'Task 1.3', start_date: date + 6.days, end_date: date + 10.days, update_url: '/gantt_chart/4', parent_id: 1 },
          { id: 5, name: 'Task 1.3.1', start_date: date + 10.days, end_date: date + 16.days, update_url: '/gantt_chart/5', parent_id: 4 },
          { id: 6, name: 'Task 1.3.2', start_date: date + 12.days, end_date: date + 16.days, update_url: '/gantt_chart/6', parent_id: 4 },
          { id: 7, name: 'Task 1.3.3', start_date: date + 14.days, end_date: date + 16.days, update_url: '/gantt_chart/7', parent_id: 4 },
          { id: 8, name: 'Task 2 with a very long name', start_date: date += 16.days, end_date: date + 2.days, update_url: '/gantt_chart/8' },
