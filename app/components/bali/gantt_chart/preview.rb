  ...
  module GanttChart
    class Preview < ApplicationViewComponentPreview
      def default
        ...
        tasks = [
          { id: 1, name: 'Task 1', start_date: date, end_date: date + 2.days, update_url: '/gantt_chart/1', href: '/gantt_chart/1', data: { action: 'modal#open' } },
          ...
          { id: 8, name: 'Task 2 with a very long name', start_date: date, end_date: date + 4.days, update_url: '/gantt_chart/8' },
