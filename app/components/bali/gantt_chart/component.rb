  ...
  module GanttChart
    class Component < ApplicationViewComponent
      ...
      def setup_options(options)
        ...
        @options = prepend_action(@options, "bali:sortable-list:end->gantt-chart#onItemReordered")
        @options = prepend_action(@options, "bali:interact:resizing->gantt-chart#onItemResizing")
        @options = prepend_action(@options, "bali:interact:resize-end->gantt-chart#onItemResized")
        @options = prepend_action(@options, "bali:interact:dragging->gantt-chart#onItemDragging")
        @options = prepend_action(@options, "bali:interact:drag-end->gantt-chart#onItemDragged")
        @options = prepend_action(@options, "bali:gantt-foldable-item:toggle->gantt-chart#onFold")
        @options = prepend_action(@options, "bali:hovercard:show->gantt-chart#onActionsOpen")
