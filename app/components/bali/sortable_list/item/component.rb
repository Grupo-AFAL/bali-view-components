    ...
    module Item
      class Component < ApplicationViewComponent
        ...
        def initialize(update_url:, item_pull: true, **options)
          @options = prepend_class_name(options, 'sortable-item p-2 bg-base-100 border border-base-300 first:rounded-t last:rounded-b [&_.sortable-list-component]:pl-4 [&_.sortable-list-component]:pt-2')
